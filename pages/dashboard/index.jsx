...
export default function Index() {
  ...
  return (
    <main className="p-6 sm:p-10 space-y-6 dark:bg-[#1E1E1E] ">
      ...
      <section className=' flex flex-col lg:flex-row lg:space-x-6'>
        <div className='basis-full dark:bg-light-black  dark:text-white lg:basis-1/2 rounded-lg bg-white'>
          <div className='mt-5 flex flex-row justify-between'>
            <span className='ml-4 heading-widgets dark:text-white'>Visitors</span>
            <div className='items-end'>
              <div className='mr-4 dark:bg-light-black  bg-white border-[1px] border-gray px-4 py-2 rounded-xl' >
                <select className="flat-select font-[DM-Sans] dark:bg-light-black bg-white text-xs max-h-[20px] focus:outline-none focus:shadow-white">
                  <option className="text-xs dark:text-white">05-10 May</option>
        ...
        <div className='basis-full lg:basis-1/2 rounded-lg dark:bg-light-black bg-white mt-6 lg:mt-0'>
          <div className='mt-5 font-[DM-sans] first-letter  flex flex-row  justify-between '>
            <span className='ml-4 heading-widgets dark:text-white'>Recent Wallet Worth</span>
            <div className='text-voilet-light-8  items-end'>
              <span className='mr-4 heading-widgets dark:text-purple-text'>View all</span>
            </div>
          </div>
          <UserTable />
        </div>
